...
<div class="body">
	...
	<div class="row">
		<div class="col-md-6">
		<form action="search_device_form.php" id="warinqform" method="get" autocomplete="off">
										...
										<input type="submit" value="Cihaz Sorgula" class="btn btn-primary" style="width:100%" name="garanti_sorgula"></input><br>&nbsp;
									</form>
	</div>
