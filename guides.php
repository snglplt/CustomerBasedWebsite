...
<meta name="keywords" content="Teknik Servis, Kullanım Kılavuzları">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<ul class="team-list sort-destination" data-sort-id="team">
				<li class="col-md-3">
					<a href="deermavacuum.php">Deerma Vacuum Cleaner VC-40</a>	
				</li>
				<li class="col-md-3">
				<a href="mibodycosposition.php">Mi Body Cosposition Scale 2 KK</a>
				</li>
				<li class="col-md-3">
				<a href="xiaomiMiTvBoxSKullanımKılavuzu.php">Xiaomi Mi Tv Box S</a>
				</li>
				<li class="col-md-3">
				<a href="bandXiaomi6.php">Xiaomi Band 6</a>
				</li>
			</ul>
			<ul class="team-list sort-destination" data-sort-id="team" >
				<li class="col-md-3" style="margin-top:20px">
					<a href="MiMotionActivatedNightLight2.php">Mi Motion Activated Night Light 2</a>	
				</li>
				<li class="col-md-3" style="margin-top:20px">
					<a href="XiaomiMiSmartBand6.php">Xiaomi Mi Smart Band 6</a>	
				</li>
				<li class="col-md-3" style="margin-top:20px">
					<a href="MiWatchLiteSite.php">Mi Watch Lite Site</a>	
				</li>
		</div>
	</div>
</div>
