...
<meta name="keywords" content="Teknik Servis, Arıza Takip">
	...
	<div class="row" id="loginloadmsg" style="display:none;">
		...
		<div class="col-md-12">
			...
			<div class="row featured-boxes login">
					...
					<div class="featured-box featured-box-secundary default info-content">	
						<div class="box-content">
								...
								<form action="yap_giris.php" id="loginform" method="post" autocomplete="off">
									...
									<input type="hidden" name="referer_url" value="index.php">
									<div class="row">
										...
										<div class="form-group">
											<div class="col-md-12">
												<a class="pull-right" href="#">
													Şifremi Unuttum!</a>
												<label>Parola</label>
												<input type="password" value="" name="pass" id="upass" class="form-control input-lg" required="required">
											</div>
										</div>
									</div>
									<div class="row">
				...
				<div class="col-sm-6">
					<div class="featured-box featured-box-secundary default info-content">
						<div class="box-content" style="background-image:url('../../img/soru.html'); background-repeat:no-repeat; background-position: right top;">
							<h4>Hala VTM TEKNİK Sistemine Üye Değil misiniz?</h4>
								<div class="row">
									<div class="col-md-12" style="text-align:justify; font-weight:600">
									Eğer hala üye değilseniz, formu doldurarak hızlı bir şekilde bir çok avantajın bulunduğu VTM TEKNİK Sistemi’ne sizde katılabilirsiniz.									<br><br>Sistemimize üye olarak anlık Cihaz Takibi, son sürüm yazılım güncellemelerinin indirebildiği Yazılım Destek ve Ticket Sistemi gibi bir çok avantajdan faydalanabilirsiniz.</div>
								</div>
								<hr class="tall">
								<div class="row" align="center">
									<a href="../accounts/register.html" class="btn btn-primary">
										Ayrıcalıklar Dünyasına KATIL</a>
								</div>
						</div>
					</div>
				</div>
