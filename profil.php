...
<div class="body">
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb">
							...
							<li class="active"><i class="fa fa-home"></i> Cihaz Girişi</li>
						</ul>
					</div>
				</div>
				<div class="row">
		...
		<div class="container">
		<form action="profil-update.php" method="post" autocomplete="off">
	<div class="row">
		<div class="col-md-6">
			<h3>PROFİL BİLGİLERİNİZ</h3>
<div class="mb-3">
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" name="email" required value="<?php if(isset($email)) echo $email;?>"></input>
</div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Şifre</label>
  <input type="text" class="form-control" name="sifre" required value="<?php if(isset($sifre)) echo $sifre;?>"></input>
</div>
