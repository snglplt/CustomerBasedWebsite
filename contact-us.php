...
<div class="container">
	...
	<div class="row">
			...
			<div class="row" id="contactloadmsg" style="display:none;">
				<div class="col-md-12">
		...
		<div class="col-md-6 col-sm-12">
							<div style="position:absolute; float:left;"><span class="arrow vbl hidden-xs hidden-sm hidden-md" data-appear-animation="rotateInDownLeft" 
				style="top: 0px; right:-435px"></span></div>

			<h4 class="push-top">Arıza <strong>Takip</strong> & Garanti <strong>Sorgulama</strong></h4>
			
			<p>
				Cihazınız <strong>VTM TEKNİK</strong> Garantisinde mi?				<span class="ozel" style="color:blue;">
					<a href="warranty-inquiry.php" style="color:blue" target="_blank">
						Garanti Sorgulama</a>
				</span>
				
			</p>
			<p>
				Cihazınızın <strong>Onarım Durumunu</strong> Takip Edebilirsiniz.				<span class="ozel" style="color:blue;">
					<a href="fault-tracking.php" style="color:blue" target="_blank">
						Arıza Takip</a>
				</span>
				
			</p>
			<p>
				Size en yakın bölge servisi nerede?				<span class="ozel" style="color:blue;">
					<a href="regional-services.php" style="color:blue" target="_blank">
						Bölge Servislerimiz</a>
				</span>
			...
			<h4>VTM <strong>TEKNİK</strong></h4>
