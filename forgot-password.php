...
<meta name="description" content="Hesaplar, Şifremi Unuttum">
<base >
						...
						<div class="panel panel-default">
							...
							<div id="collapseOne" class="accordion-body collapse in">
								<div class="panel-body">
											<form action="SifreDegistir" id="forgotpassform" method="post" autocomplete="off">
											<input type="hidden" name="forgotpass" value="1">
											<div class="row">
												<div class="form-group">
													<div class="col-md-12">
														<label>E-Posta <code>*</code></label>
														<input id="eposta" name="eposta" type="text" class="form-control input-lg" 
															value="">
													</div>
												</div>
											</div>
...
<?php
if($_GET){
	$sifredurumu=$_GET['sifredurumu'];
if($sifredurumu=="mailKontrol"){	
