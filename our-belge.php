...
<div class="body">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 sertifika1" ><img style="width:400px;height:283px;margin:20px" src="images/belgeler/tmarkt.PNG" /></div>
				<div class="col-md-6 sertifika2"><img  style="width:400px;height:283px;margin:20px;" src="images/belgeler/deerma.PNG"/></div>
			</div>	
